    ...
    <section class="tops-section">
        ...
        <div class="top-card">
            ...
            <ul class="top-list">
                ...
                <li>
                    <?php $lala_page = get_page_by_path('la-la-land'); ?>
                    ...
                    <button class="like-btn" data-liked="false" data-type="film" data-id="<?php echo esc_attr($lala_page ? $lala_page->ID : ''); ?>" data-poster="<?php echo esc_url( get_template_directory_uri() . '/assets/image/Fiche films/La La Land.jpg' ); ?>" type="button" aria-label="Like">♡</button>
                </li>
                <li>
                    <?php $parasite_page = get_page_by_path('parasite'); ?>
                    ...
                    <button class="like-btn" data-liked="false" data-type="film" data-id="<?php echo esc_attr($parasite_page ? $parasite_page->ID : ''); ?>" data-poster="<?php echo esc_url( get_template_directory_uri() . '/assets/image/Fiche films/Parasite.jpg' ); ?>" type="button" aria-label="Like">♡</button>
                </li>
                <li>
                    <?php $interstellar_page = get_page_by_path('interstellar'); ?>
                    ...
                    <button class="like-btn" data-liked="false" data-type="film" data-id="<?php echo esc_attr($interstellar_page ? $interstellar_page->ID : ''); ?>" data-poster="<?php echo esc_url( get_template_directory_uri() . '/assets/image/Fiche films/Interstellar.jpg' ); ?>" type="button" aria-label="Like">♡</button>
                </li>
                <li>
                    <?php $arrival_page = get_page_by_path('arrival'); ?>
                    ...
                    <button class="like-btn" data-liked="false" data-type="film" data-id="<?php echo esc_attr($arrival_page ? $arrival_page->ID : ''); ?>" data-poster="<?php echo esc_url( get_template_directory_uri() . '/assets/image/Fiche films/Arrival.webp' ); ?>" type="button" aria-label="Like">♡</button>
                </li>
            </ul>
        </div>
        ...
        <div class="top-card">
            ...
            <ul class="top-list">
                <li>
                    <?php $yourname_page = get_page_by_path('your-name'); ?>
                    <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/image/Front Page/your name.jpg' ); ?>" alt="Your Name">
                    <div class="top-info">
                    ...
                    <button class="like-btn" data-liked="false" data-type="film" data-id="<?php echo esc_attr($yourname_page ? $yourname_page->ID : ''); ?>" data-poster="<?php echo esc_url( get_template_directory_uri() . '/assets/image/Fiche films/your name.jpg' ); ?>" type="button" aria-label="Like">♡</button>
                </li>
                <li>
                    <?php $chihiro_page = get_page_by_path('spirited-away'); ?>
                    ...
                    <button class="like-btn" data-liked="false" data-type="film" data-id="<?php echo esc_attr($chihiro_page ? $chihiro_page->ID : ''); ?>" data-poster="<?php echo esc_url( get_template_directory_uri() . '/assets/image/Fiche films/chihiro.jpg' ); ?>" type="button" aria-label="Like">♡</button>
                </li>
                <li>
                    <?php $aot_page = get_page_by_path('attack-on-titan'); ?>
                    ...
                    <button class="like-btn" data-liked="false" data-type="serie" data-id="<?php echo esc_attr($aot_page ? $aot_page->ID : ''); ?>" data-poster="<?php echo esc_url( get_template_directory_uri() . '/assets/image/Fiche films/attack on titan.jpg' ); ?>" type="button" aria-label="Like">♡</button>
                </li>
                <li>
                    <?php $demonslayer_page = get_page_by_path('demon-slayer'); ?>
                    ...
                    <button class="like-btn" data-liked="false" data-type="film" data-id="<?php echo esc_attr($demonslayer_page ? $demonslayer_page->ID : ''); ?>" data-poster="<?php echo esc_url( get_template_directory_uri() . '/assets/image/Fiche films/demon slayer.jpg' ); ?>" type="button" aria-label="Like">♡</button>
                </li>
                <li>
                    <?php $jujutsu_page = get_page_by_path('jujutsu-kaisen'); ?>
                    ...
                    <button class="like-btn" data-liked="false" data-type="film" data-id="<?php echo esc_attr($jujutsu_page ? $jujutsu_page->ID : ''); ?>" data-poster="<?php echo esc_url( get_template_directory_uri() . '/assets/image/Fiche films/jujutsu kaisen.jpg' ); ?>" type="button" aria-label="Like">♡</button>
                </li>
            </ul>
        </div>
    </section>
